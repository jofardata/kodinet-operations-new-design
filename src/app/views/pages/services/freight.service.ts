...
//fucntion qui recupere tous ce qui a dans freight du back-end airports
  public getAllFreight(){
    return this.http.get<any>(this.urlService.bdnUrl+ "/freights/find-all",{observe:'response'})
   }

  //  function of pagination with angular
   public getPagedData(page, size){
    return this.http.get<any>(this.urlService.bdnUrl+ "/freights/pages?page="+page+"&size="+size,{observe:'response'}) 
   }
